...
public class InteractablePocionVerde : AbstractInteractable
{
    ...
    { 
        ...
        pocionResultado = "";
        pocionClicada = "pocion_objetivo_verde";
        clicada = false;
    }
    public void Update()
    {
        if (clicada)
        {
            ...
            else if (pocionActual == "pocion_objetivo_morada")
            {
                ...
                GameObject pocClicada = GameObject.FindGameObjectWithTag("pocion_objetivo_negra");
                pocClicada.transform.position = new Vector3(pocClicada.transform.position.x, pocClicada.transform.position.y + 2f, pocClicada.transform.position.z);
            }
